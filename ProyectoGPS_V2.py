...
Agregar = tkinter.Button(ventana, image=imgBoton3, cursor = "hand2", command = agregar, width=40, height=50)
Comprar = tkinter.Button(ventana, image=imgBoton4, cursor = "hand2", command = comprar, width=40, height=50)
